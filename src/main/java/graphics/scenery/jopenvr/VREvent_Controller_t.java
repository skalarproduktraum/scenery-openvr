 ...
 */
public class VREvent_Controller_t extends Structure<VREvent_Controller_t, VREvent_Controller_t.ByValue, VREvent_Controller_t.ByReference > {
	public int button;
	...
	protected VREvent_Controller_t newInstance() { return new VREvent_Controller_t(); }
	public static VREvent_Controller_t[] newArray(int arrayLength) {
		return Structure.newArray(VREvent_Controller_t.class, arrayLength);
	}
