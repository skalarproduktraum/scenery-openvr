 ...
 */
public class VR_IVRCompositor_FnTable extends Structure<VR_IVRCompositor_FnTable, VR_IVRCompositor_FnTable.ByValue, VR_IVRCompositor_FnTable.ByReference > {
	...
	public interface GetCurrentFadeColor_callback extends Callback {
		graphics.scenery.jopenvr.HmdColor_t.ByValue apply(byte bBackground);
	};
	...
	protected VR_IVRCompositor_FnTable newInstance() { return new VR_IVRCompositor_FnTable(); }
	public static VR_IVRCompositor_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVRCompositor_FnTable.class, arrayLength);
	}
