 ...
 */
public class CameraVideoStreamFrameHeader_t extends Structure<CameraVideoStreamFrameHeader_t, CameraVideoStreamFrameHeader_t.ByValue, CameraVideoStreamFrameHeader_t.ByReference > {
	...
	protected CameraVideoStreamFrameHeader_t newInstance() { return new CameraVideoStreamFrameHeader_t(); }
	public static CameraVideoStreamFrameHeader_t[] newArray(int arrayLength) {
		return Structure.newArray(CameraVideoStreamFrameHeader_t.class, arrayLength);
	}
