 ...
 */
public class VROverlayIntersectionParams_t extends Structure<VROverlayIntersectionParams_t, VROverlayIntersectionParams_t.ByValue, VROverlayIntersectionParams_t.ByReference > {
	...
	protected VROverlayIntersectionParams_t newInstance() { return new VROverlayIntersectionParams_t(); }
	public static VROverlayIntersectionParams_t[] newArray(int arrayLength) {
		return Structure.newArray(VROverlayIntersectionParams_t.class, arrayLength);
	}
