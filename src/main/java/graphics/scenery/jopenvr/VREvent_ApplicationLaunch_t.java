 ...
 */
public class VREvent_ApplicationLaunch_t extends Structure<VREvent_ApplicationLaunch_t, VREvent_ApplicationLaunch_t.ByValue, VREvent_ApplicationLaunch_t.ByReference > {
	public int pid;
	...
	protected VREvent_ApplicationLaunch_t newInstance() { return new VREvent_ApplicationLaunch_t(); }
	public static VREvent_ApplicationLaunch_t[] newArray(int arrayLength) {
		return Structure.newArray(VREvent_ApplicationLaunch_t.class, arrayLength);
	}
