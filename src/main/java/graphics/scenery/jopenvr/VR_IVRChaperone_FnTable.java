 ...
 */
public class VR_IVRChaperone_FnTable extends Structure<VR_IVRChaperone_FnTable, VR_IVRChaperone_FnTable.ByValue, VR_IVRChaperone_FnTable.ByReference > {
	...
	protected VR_IVRChaperone_FnTable newInstance() { return new VR_IVRChaperone_FnTable(); }
	public static VR_IVRChaperone_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVRChaperone_FnTable.class, arrayLength);
	}
