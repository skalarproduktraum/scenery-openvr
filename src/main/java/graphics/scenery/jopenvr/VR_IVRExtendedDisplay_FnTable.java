 ...
 */
public class VR_IVRExtendedDisplay_FnTable extends Structure<VR_IVRExtendedDisplay_FnTable, VR_IVRExtendedDisplay_FnTable.ByValue, VR_IVRExtendedDisplay_FnTable.ByReference > {
	...
	protected VR_IVRExtendedDisplay_FnTable newInstance() { return new VR_IVRExtendedDisplay_FnTable(); }
	public static VR_IVRExtendedDisplay_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVRExtendedDisplay_FnTable.class, arrayLength);
	}
