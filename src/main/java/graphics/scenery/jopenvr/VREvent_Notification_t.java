 ...
 */
public class VREvent_Notification_t extends Structure<VREvent_Notification_t, VREvent_Notification_t.ByValue, VREvent_Notification_t.ByReference > {
	...
	protected VREvent_Notification_t newInstance() { return new VREvent_Notification_t(); }
	public static VREvent_Notification_t[] newArray(int arrayLength) {
		return Structure.newArray(VREvent_Notification_t.class, arrayLength);
	}
