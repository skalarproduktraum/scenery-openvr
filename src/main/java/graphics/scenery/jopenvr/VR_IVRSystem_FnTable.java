 ...
 */
public class VR_IVRSystem_FnTable extends Structure<VR_IVRSystem_FnTable, VR_IVRSystem_FnTable.ByValue, VR_IVRSystem_FnTable.ByReference > {
	...
	public graphics.scenery.jopenvr.VR_IVRExtendedDisplay_FnTable.GetDXGIOutputInfo_callback GetDXGIOutputInfo;
	...
	public interface GetProjectionMatrix_callback extends Callback {
		graphics.scenery.jopenvr.HmdMatrix44_t.ByValue apply(int eEye, float fNearZ, float fFarZ);
	};
	...
	public interface GetHiddenAreaMesh_callback extends Callback {
		graphics.scenery.jopenvr.HiddenAreaMesh_t.ByValue apply(int eEye, int type);
	};
	...
	protected VR_IVRSystem_FnTable newInstance() { return new VR_IVRSystem_FnTable(); }
	public static VR_IVRSystem_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVRSystem_FnTable.class, arrayLength);
	}
