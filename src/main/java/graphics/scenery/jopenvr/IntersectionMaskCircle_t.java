 ...
 */
public class IntersectionMaskCircle_t extends Structure<IntersectionMaskCircle_t, IntersectionMaskCircle_t.ByValue, IntersectionMaskCircle_t.ByReference > {
	...
	protected IntersectionMaskCircle_t newInstance() { return new IntersectionMaskCircle_t(); }
	public static IntersectionMaskCircle_t[] newArray(int arrayLength) {
		return Structure.newArray(IntersectionMaskCircle_t.class, arrayLength);
	}
