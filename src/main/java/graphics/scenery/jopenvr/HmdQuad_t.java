 ...
 */
public class HmdQuad_t extends Structure<HmdQuad_t, HmdQuad_t.ByValue, HmdQuad_t.ByReference > {
	...
	protected HmdQuad_t newInstance() { return new HmdQuad_t(); }
	public static HmdQuad_t[] newArray(int arrayLength) {
		return Structure.newArray(HmdQuad_t.class, arrayLength);
	}
