 ...
 */
public class DistortionCoordinates_t extends Structure<DistortionCoordinates_t, DistortionCoordinates_t.ByValue, DistortionCoordinates_t.ByReference > {
	/** float[2] */
	...
	protected DistortionCoordinates_t newInstance() { return new DistortionCoordinates_t(); }
	public static DistortionCoordinates_t[] newArray(int arrayLength) {
		return Structure.newArray(DistortionCoordinates_t.class, arrayLength);
	}
