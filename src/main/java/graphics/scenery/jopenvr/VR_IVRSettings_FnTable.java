 ...
 */
public class VR_IVRSettings_FnTable extends Structure<VR_IVRSettings_FnTable, VR_IVRSettings_FnTable.ByValue, VR_IVRSettings_FnTable.ByReference > {
	...
	protected VR_IVRSettings_FnTable newInstance() { return new VR_IVRSettings_FnTable(); }
	public static VR_IVRSettings_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVRSettings_FnTable.class, arrayLength);
	}
