 ...
 */
public class VR_IVRScreenshots_FnTable extends Structure<VR_IVRScreenshots_FnTable, VR_IVRScreenshots_FnTable.ByValue, VR_IVRScreenshots_FnTable.ByReference > {
	...
	protected VR_IVRScreenshots_FnTable newInstance() { return new VR_IVRScreenshots_FnTable(); }
	public static VR_IVRScreenshots_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVRScreenshots_FnTable.class, arrayLength);
	}
