 ...
 */
public class Compositor_FrameTiming extends Structure<Compositor_FrameTiming, Compositor_FrameTiming.ByValue, Compositor_FrameTiming.ByReference > {
	public int m_nSize;
	...
	protected Compositor_FrameTiming newInstance() { return new Compositor_FrameTiming(); }
	public static Compositor_FrameTiming[] newArray(int arrayLength) {
		return Structure.newArray(Compositor_FrameTiming.class, arrayLength);
	}
