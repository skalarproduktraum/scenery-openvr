 ...
 */
public class VREvent_Keyboard_t extends Structure<VREvent_Keyboard_t, VREvent_Keyboard_t.ByValue, VREvent_Keyboard_t.ByReference > {
	/** char[8] */
	...
	protected VREvent_Keyboard_t newInstance() { return new VREvent_Keyboard_t(); }
	public static VREvent_Keyboard_t[] newArray(int arrayLength) {
		return Structure.newArray(VREvent_Keyboard_t.class, arrayLength);
	}
