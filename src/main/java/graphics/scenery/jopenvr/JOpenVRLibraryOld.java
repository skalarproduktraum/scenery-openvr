 ...
 */
public class JOpenVRLibraryOld implements Library {
	public static final String JNA_LIBRARY_NAME = "openvr_api";
	public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(JOpenVRLibraryOld.JNA_LIBRARY_NAME);
	static {
		Native.register(JOpenVRLibraryOld.class, JOpenVRLibraryOld.JNA_NATIVE_LIB);
	}
	/** enum values */
