 ...
 */
public class VR_IVRNotifications_FnTable extends Structure<VR_IVRNotifications_FnTable, VR_IVRNotifications_FnTable.ByValue, VR_IVRNotifications_FnTable.ByReference > {
	...
	protected VR_IVRNotifications_FnTable newInstance() { return new VR_IVRNotifications_FnTable(); }
	public static VR_IVRNotifications_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVRNotifications_FnTable.class, arrayLength);
	}
