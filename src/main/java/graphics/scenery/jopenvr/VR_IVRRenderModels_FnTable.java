 ...
 */
public class VR_IVRRenderModels_FnTable extends Structure<VR_IVRRenderModels_FnTable, VR_IVRRenderModels_FnTable.ByValue, VR_IVRRenderModels_FnTable.ByReference > {
	...
	protected VR_IVRRenderModels_FnTable newInstance() { return new VR_IVRRenderModels_FnTable(); }
	public static VR_IVRRenderModels_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVRRenderModels_FnTable.class, arrayLength);
	}
