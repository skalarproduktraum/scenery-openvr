 ...
 */
public class VR_IVRTrackedCamera_FnTable extends Structure<VR_IVRTrackedCamera_FnTable, VR_IVRTrackedCamera_FnTable.ByValue, VR_IVRTrackedCamera_FnTable.ByReference > {
	...
	protected VR_IVRTrackedCamera_FnTable newInstance() { return new VR_IVRTrackedCamera_FnTable(); }
	public static VR_IVRTrackedCamera_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVRTrackedCamera_FnTable.class, arrayLength);
	}
