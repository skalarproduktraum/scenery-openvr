 ...
 */
public class Compositor_CumulativeStats extends Structure<Compositor_CumulativeStats, Compositor_CumulativeStats.ByValue, Compositor_CumulativeStats.ByReference > {
	public int m_nPid;
	...
	protected Compositor_CumulativeStats newInstance() { return new Compositor_CumulativeStats(); }
	public static Compositor_CumulativeStats[] newArray(int arrayLength) {
		return Structure.newArray(Compositor_CumulativeStats.class, arrayLength);
	}
