 ...
 */
public class VR_IVROverlay_FnTable extends Structure<VR_IVROverlay_FnTable, VR_IVROverlay_FnTable.ByValue, VR_IVROverlay_FnTable.ByReference > {
	...
	public interface SetKeyboardPositionForOverlay_callback extends Callback {
		void apply(long ulOverlayHandle, graphics.scenery.jopenvr.HmdRect2_t.ByValue avoidRect);
	};
	...
	protected VR_IVROverlay_FnTable newInstance() { return new VR_IVROverlay_FnTable(); }
	public static VR_IVROverlay_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVROverlay_FnTable.class, arrayLength);
	}
