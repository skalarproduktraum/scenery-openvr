 ...
 */
public class VREvent_Overlay_t extends Structure<VREvent_Overlay_t, VREvent_Overlay_t.ByValue, VREvent_Overlay_t.ByReference > {
	...
	protected VREvent_Overlay_t newInstance() { return new VREvent_Overlay_t(); }
	public static VREvent_Overlay_t[] newArray(int arrayLength) {
		return Structure.newArray(VREvent_Overlay_t.class, arrayLength);
	}
