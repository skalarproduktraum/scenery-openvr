 ...
 */
public class VR_IVRApplications_FnTable extends Structure<VR_IVRApplications_FnTable, VR_IVRApplications_FnTable.ByValue, VR_IVRApplications_FnTable.ByReference > {
	...
	protected VR_IVRApplications_FnTable newInstance() { return new VR_IVRApplications_FnTable(); }
	public static VR_IVRApplications_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVRApplications_FnTable.class, arrayLength);
	}
