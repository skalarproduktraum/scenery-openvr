 ...
 */
public class VR_IVRChaperoneSetup_FnTable extends Structure<VR_IVRChaperoneSetup_FnTable, VR_IVRChaperoneSetup_FnTable.ByValue, VR_IVRChaperoneSetup_FnTable.ByReference > {
	...
	protected VR_IVRChaperoneSetup_FnTable newInstance() { return new VR_IVRChaperoneSetup_FnTable(); }
	public static VR_IVRChaperoneSetup_FnTable[] newArray(int arrayLength) {
		return Structure.newArray(VR_IVRChaperoneSetup_FnTable.class, arrayLength);
	}
