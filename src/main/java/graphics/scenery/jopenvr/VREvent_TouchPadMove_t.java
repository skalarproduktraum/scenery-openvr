 ...
 */
public class VREvent_TouchPadMove_t extends Structure<VREvent_TouchPadMove_t, VREvent_TouchPadMove_t.ByValue, VREvent_TouchPadMove_t.ByReference > {
	...
	protected VREvent_TouchPadMove_t newInstance() { return new VREvent_TouchPadMove_t(); }
	public static VREvent_TouchPadMove_t[] newArray(int arrayLength) {
		return Structure.newArray(VREvent_TouchPadMove_t.class, arrayLength);
	}
