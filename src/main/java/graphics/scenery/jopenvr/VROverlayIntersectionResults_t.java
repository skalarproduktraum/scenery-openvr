 ...
 */
public class VROverlayIntersectionResults_t extends Structure<VROverlayIntersectionResults_t, VROverlayIntersectionResults_t.ByValue, VROverlayIntersectionResults_t.ByReference > {
	...
	protected VROverlayIntersectionResults_t newInstance() { return new VROverlayIntersectionResults_t(); }
	public static VROverlayIntersectionResults_t[] newArray(int arrayLength) {
		return Structure.newArray(VROverlayIntersectionResults_t.class, arrayLength);
	}
