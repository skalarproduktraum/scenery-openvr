 ...
 */
public class VREvent_Reserved_t extends Structure<VREvent_Reserved_t, VREvent_Reserved_t.ByValue, VREvent_Reserved_t.ByReference > {
	...
	protected VREvent_Reserved_t newInstance() { return new VREvent_Reserved_t(); }
	public static VREvent_Reserved_t[] newArray(int arrayLength) {
		return Structure.newArray(VREvent_Reserved_t.class, arrayLength);
	}
