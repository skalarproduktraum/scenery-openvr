 ...
 */
public class VREvent_Status_t extends Structure<VREvent_Status_t, VREvent_Status_t.ByValue, VREvent_Status_t.ByReference > {
	...
	protected VREvent_Status_t newInstance() { return new VREvent_Status_t(); }
	public static VREvent_Status_t[] newArray(int arrayLength) {
		return Structure.newArray(VREvent_Status_t.class, arrayLength);
	}
