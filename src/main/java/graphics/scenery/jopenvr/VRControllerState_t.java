 ...
 */
public class VRControllerState_t extends Structure<VRControllerState_t, VRControllerState_t.ByValue, VRControllerState_t.ByReference > {
	...
	protected VRControllerState_t newInstance() { return new VRControllerState_t(); }
	public static VRControllerState_t[] newArray(int arrayLength) {
		return Structure.newArray(VRControllerState_t.class, arrayLength);
	}
