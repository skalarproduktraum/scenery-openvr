 ...
 */
public class IntersectionMaskRectangle_t extends Structure<IntersectionMaskRectangle_t, IntersectionMaskRectangle_t.ByValue, IntersectionMaskRectangle_t.ByReference > {
	...
	protected IntersectionMaskRectangle_t newInstance() { return new IntersectionMaskRectangle_t(); }
	public static IntersectionMaskRectangle_t[] newArray(int arrayLength) {
		return Structure.newArray(IntersectionMaskRectangle_t.class, arrayLength);
	}
