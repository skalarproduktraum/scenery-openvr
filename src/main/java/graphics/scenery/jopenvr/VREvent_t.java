 ...
 */
public class VREvent_t extends Structure<VREvent_t, VREvent_t.ByValue, VREvent_t.ByReference > {
	/** EVREventType enum */
	...
	protected VREvent_t newInstance() { return new VREvent_t(); }
	public static VREvent_t[] newArray(int arrayLength) {
		return Structure.newArray(VREvent_t.class, arrayLength);
	}
